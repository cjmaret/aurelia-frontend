export const Colors = {
  light: {
    ...
    // misc colors
    grammarReviewHeaderBorder: '#e7eaef',
  ...
  dark: {
    ...
    cardShadowBottomGradient: 'rgba(45, 46, 46, 0.8)',

    // modal colors:
    modalBackgroundPrimary: '#787878',
    modalTextPrimary: '',
    ...
    // greys
    greyPrimary: '#A6B0BB',
    greySecondary: '#767676',
    greyTertiary: '#888',
    modalOverlay: '#00000080',

    // misc colors
    grammarReviewHeaderBorder: '#2A2E33',
    dateSeparatorColor: '#81c6d0',
    rippleBorder: '#39505a',
